...
import { buildResumeDocxBuffer } from '@/lib/jobs/packet-material-export'
import { buildResumeMaterialReview } from '@/lib/jobs/packet-materials'
...
export async function GET(_request: Request, { params }: RouteContext) {
  ...
  const materialReview = buildResumeMaterialReview({
