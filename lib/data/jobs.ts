...
function normalizeRankedJob(value: unknown): RankedJobRecord | null {
  ...
  return {
    ...
    descriptionText: asString(job.description_text),
    descriptionTextFetched: asString(job.description_text_fetched) || undefined,
    descriptionFetchedAt: asString(job.description_fetched_at) || undefined,
    descriptionFetchError: asString(job.description_fetch_error) || undefined,
    primaryIndustry: asString(job.primary_industry) || undefined,
    adjacentIndustries: asStringArray(job.adjacent_industries),
    industryEvidence: asStringArray(job.industry_evidence),
    industryClassifiedAt: asString(job.industry_classified_at) || undefined,
